...
namespace Kit.Web.Accounts.Admin
{
	/// <summary>
	/// UserAdmin 的摘要说明。
	/// </summary>
	public partial class UserAdmin : System.Web.UI.Page//Kit.Web.Accounts.MoviePage//MmyeeAd.Web.Accounts.MoviePage
	{
				...
				case ListItemType.AlternatingItem:
					...
					else
					{
                        switch (UserType)
                        {
                            ...
                            case "PP":
                                {
                                    //if (Kit.Common.PageValidate.IsNumber(DepartmentID))
                                    //{
