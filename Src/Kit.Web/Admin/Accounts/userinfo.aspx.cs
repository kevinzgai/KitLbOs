		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			{			
				...
				if (Context.User.Identity.IsAuthenticated)
				{
                    ...
                    //{
                    //    string herosoftmana=Kit.Common.ConfigHelper.GetConfigString("AdManager");
                    //    this.lblDepart.Text=herosoftmana;
                    //}
                    //else
                    //{
						
                    //        if(Kit.Common.PageValidate.IsNumber(currentUser.DepartmentID))
                    //        {
                    //            Kit.BLL.ADManage.AdSupplier supp=new Kit.BLL.ADManage.AdSupplier();
                    //            Kit.Model.ADManage.AdSupplier suppmodel=supp.GetModel(int.Parse(currentUser.DepartmentID));
