...
namespace Kit.Web.Admin
{
    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        private void btnLogin_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ...
            string userName = Kit.Common.PageValidate.InputText(txtUsername.Value.Trim(), 30);
            string Password = Kit.Common.PageValidate.InputText(txtPass.Value.Trim(), 30);
