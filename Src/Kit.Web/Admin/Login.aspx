<%@ Page Language="c#" CodeBehind="Login.aspx.cs" AutoEventWireup="True" Inherits="Kit.Web.Admin.Login" %>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="right" valign="top">
                                                <br>
                                                &nbsp;
                                                <img height="9" src="images/point07.gif" width="13" border="0"><a href="#" onclick="window.external.addFavorite('http://www.Kit.com','动软管理系统')">加入收藏</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td height="70" align="center">
                                            Copyright(C) 2004-2008 Kit All Rights Reserved.
                                        </td>
                                    </tr>
                                </table>
                            </td>
