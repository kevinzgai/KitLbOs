...
//		{
//			DataSet ds=Kit.BLL.PubConstant.GetAllKeShi();
...
//		}
		...
		protected void btnAdd_Click(object sender, System.EventArgs e)
		{
			...
			string id=Kit.Common.PageValidate.InputText(this.lblID.Text,10);
			string orderid=Kit.Common.PageValidate .InputText(this.txtOrderid.Text,5);
			string name=txtName.Text;
			string url=Kit.Common.PageValidate.InputText(txtUrl.Text,100);
//			string imgUrl=Kit.Common.PageValidate.InputText(txtImgUrl.Text,100);
			...
			if(strErr!="")
			{
				Kit.Common.MessageBox.Show(this,strErr);
				return;
			}
...
//				keshipublic="true";
//			}
			string comment=Kit.Common.PageValidate.InputText(txtDescription.Text,100);
