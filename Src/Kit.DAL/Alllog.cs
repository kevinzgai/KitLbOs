...
namespace Kit.DAL
{
	...
	public partial class Alllog
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Aid", "Alllog"); 
		}
		...
		public bool Exists(int Aid)
		{
			...
			strSql.Append("select count(1) from Alllog");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Alllog(");
			strSql.Append("Uid,Atype,Acontent,Atime,Astate,Spare1,Spare2,Spare3)");
			strSql.Append(" values (");
			strSql.Append("@Uid,@Atype,@Acontent,@Atime,@Astate,@Spare1,@Spare2,@Spare3)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@Uid", SqlDbType.Int,4),
					new SqlParameter("@Atype", SqlDbType.Char,10),
					new SqlParameter("@Acontent", SqlDbType.NVarChar,500),
					new SqlParameter("@Atime", SqlDbType.DateTime),
					new SqlParameter("@Astate", SqlDbType.NVarChar,200),
			...
			parameters[4].Value = model.Astate;
			parameters[5].Value = model.Spare1;
			parameters[6].Value = model.Spare2;
			parameters[7].Value = model.Spare3;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Alllog set ");
		...
		public bool Delete(int Aid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Alllog ");
			strSql.Append(" where Aid=@Aid");
			SqlParameter[] parameters = {
					new SqlParameter("@Aid", SqlDbType.Int,4)
			};
		...
		public Kit.Model.Alllog GetModel(int Aid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Aid,Uid,Atype,Acontent,Atime,Astate,Spare1,Spare2,Spare3 from Alllog ");
			strSql.Append(" where Aid=@Aid");
			SqlParameter[] parameters = {
					new SqlParameter("@Aid", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Kit.Model.Alllog DataRowToModel(DataRow row)
		{
			Kit.Model.Alllog model=new Kit.Model.Alllog();
			if (row != null)
			{
				...
				if(row["Astate"]!=null)
				{
					model.Astate=row["Astate"].ToString();
				}
				if(row["Spare1"]!=null)
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select top 200 Aid,Uid,Atype,Acontent,Atime,Astate,Spare1,Spare2,Spare3 ");
			strSql.Append(" FROM Alllog ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Aid,Uid,Atype,Acontent,Atime,Astate,Spare1,Spare2,Spare3 ");
			strSql.Append(" FROM Alllog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Alllog T ");
