...
namespace Kit.BLL
{
    ...
    {
        private readonly Kit.DAL.Kuser dal = new Kit.DAL.Kuser();
        public Kuser()
        { }
        #region  BasicMethod
        ...
        {
            return dal.DeleteList(Kit.Common.PageValidate.SafeLongFilter(Uidlist, 0));
        }
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Kit.Model.Kuser GetModelByCache(int Uid)
        {

            string CacheKey = "KuserModel-" + Uid;
            ...
            return (Kit.Model.Kuser)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Kit.Model.Kuser> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Kit.Model.Kuser> DataTableToList(DataTable dt)
        {
            List<Kit.Model.Kuser> modelList = new List<Kit.Model.Kuser>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Kit.Model.Kuser model;
        ...
        {
            return dal.GetList(PageSize ,strWhere, PageIndex.ToString());
        }
